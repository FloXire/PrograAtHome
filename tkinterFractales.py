...
def creerTriangle(tailleCote):
    ...
    def fractale(coordTriangle): #crée 3 triangles au sein du triangle en question
        #condition d'arrêt
        ...
        fractale(coordNewTriangleUp)
        fractale(coordNewTriangleLeft)
        fractale(coordNewTriangleRight)

    fractale(coordTriangle)
    mainloop()
